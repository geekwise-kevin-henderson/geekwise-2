...
function getMovies(){
  var url = myVars.get_url() + "3/search/movie?api_key=" + myVars.get_api_key() + '&language=en-US&page=1&query=resident';
...
function parseMovies(movies){
  ...
  var  section = document.createElement('section'),
    ...
    poster_path.src = 'http://image.tmdb.org/t/p/w500' + m.poster_path;
    ...
    section.append( poster_path, title, tagline, overview, homepage);
    main.append(section);
  });
